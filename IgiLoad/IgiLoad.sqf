...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_EPOCH"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_EPOCH", "C_Van_01_transport_EPOCH"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_transport_EPOCH", "B_Truck_01_covered_EPOCH", "B_Truck_01_mover_EPOCH", "B_Truck_01_box_EPOCH"];
	...
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_02_covered_EPOCH", "O_Truck_02_transport_EPOCH","O_Truck_03_covered_EPOCH","O_Truck_02_box_EPOCH"];
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_EPOCH"];
	IL_Supported_Vehicles_CHINOOK = ["B_Heli_Transport_03_unarmed_EPOCH", "CH_147F", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base","B_Heli_Transport_03_unarmed_EPOCH"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_EPOCH","mosquito_epoch"];
	...
	//Supported cargo
	IL_Supported_HEMTT = 	["B_Truck_01_transport_EPOCH", 	"B_Truck_01_covered_EPOCH", "B_Truck_01_mover_EPOCH", "B_Truck_01_box_EPOCH"];
	IL_Supported_KAMAZ = 	["I_Truck_02_transport_EPOCH", 	"O_Truck_02_transport_EPOCH", "I_Truck_02_covered_EPOCH", "O_Truck_02_covered_EPOCH", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	IL_Supported_TEMPEST = 	["O_Truck_02_covered_EPOCH", 	"O_Truck_02_transport_EPOCH"];
	IL_Supported_Strider = 	["I_MRAP_03_F"];
	IL_Supported_Hunter = 	["B_MRAP_01_EPOCH"];
	...
	IL_Supported_VAN = 		["C_Van_01_box_EPOCH", 			"C_Van_01_transport_EPOCH"];
	IL_Supported_OFFROAD = 	["C_Offroad_01_EPOCH", 			"O_G_Offroad_01_armed_F"];
	IL_Supported_SUV = 		["C_SUV_01_EPOCH"];
	IL_Supported_Hatchback = ["C_Hatchback_01_EPOCH", 		"C_Hatchback_02_EPOCH"];
	...
	IL_Supported_Quadbike = ["ebike_epoch", 				"C_Quadbike_01_EPOCH","K01","K02","K03","K04"];
	...
	IL_Supported_Rubberboat = ["C_Rubberboat_EPOCH", 		"C_Rubberboat_02_EPOCH","C_Rubberboat_03_EPOCH","C_Rubberboat_04_EPOCH","C_Boat_Civil_01_EPOCH", "C_Boat_Civil_01_police_EPOCH", "C_Boat_Civil_01_rescue_EPOCH"];
	IL_Supported_SDV = 		["I_SDV_01_F", 					"O_SDV_01_F", "B_SDV_01_EPOCH", "B_mas_mar_SDV_01_F"];
	...
	IL_Supported_Cargobox = ["Land_Pod_Heli_Transport_04_bench_F", "Land_Pod_Heli_Transport_04_covered_F", "Land_Pod_Heli_Transport_04_box_F", "JNS_SkycranePod_Bench", "JNS_SkycranePod_Transport", "JNS_SkycranePod_Cargo", "Land_Pod_Heli_Transport_04_Black_bench_F", "Land_Pod_Heli_Transport_04_Black_covered_F", "Land_Pod_Heli_Transport_04_Black_box_F"];
	IL_Supported_MH9 = ["B_Heli_Light_01_EPOCH"];
	IL_Supported_jetski = ["jetski_epoch"];
	IL_Supported_mosquito = ["mosquito_epoch"];
	//TODO
	...
	IL_Supported_Cargo_Veh_Kamaz = 			IL_Supported_Quadbike + 			IL_Supported_Rubberboat + 		IL_Supported_SDV + 		IL_Supported_Hatchback + 	IL_Supported_UGV + IL_Supported_VAN +	IL_Supported_MH9 + IL_Supported_jetski + IL_Supported_mosquito;
	IL_Supported_Cargo_NonVeh_Kamaz = 		IL_Supported_Cargobox + 	IL_Supported_Supply_Crate + 		IL_Supported_Veh_Ammo + 		IL_Supported_Barrel + 	IL_Supported_Tank + 		IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Cargobox) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.8, true];//HEMETT Box ~2.09281
			//LOCAL
			//_obj setMass 2400;
			[_obj, 2400] call IL_SetNewMass;
		};
		...
		if (_obj_type in IL_Supported_mosquito) then
		{
